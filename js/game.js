...
function gameOver() {
    overDiv.innerHTML += `<img src="img/overpic.png" alt="imagem game over" class="game-over">
    <button class="buttonStart" onclick="start()">
        <img src="img/Daco_4422541.png" alt="imagem começar jogo" width="150px" class="start">
    </button>`;
}
function start() {
    location.reload();
...
function handleInstrucao(){
  ...
  inst.innerHTML += "<p><b>Using Mobile?</b> Tap the screen to jump and press<i>Start</i> to restart the game.</p>";
